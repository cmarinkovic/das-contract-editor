 ...
 */
export default function CustomViewerReplaceMenuProvider(
...
CustomViewerReplaceMenuProvider.$inject = [
    'bpmnFactory',
    'popupMenu',
    'modeling',
    'moddle',
 ...
 */
CustomViewerReplaceMenuProvider.prototype.register = function () {
 ...
 */
CustomViewerReplaceMenuProvider.prototype.getEntries = function (element) {
 ...
 * @return {Array<Object>} a list of menu entry items
 */
CustomViewerReplaceMenuProvider.prototype.getHeaderEntries = function (element) {
 ...
 */
CustomViewerReplaceMenuProvider.prototype._createEntries = function (element, replaceOptions) {
    var menuEntries = [];
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._createSequenceFlowEntries = function (element, replaceOptions) {
 ...
 */
CustomViewerReplaceMenuProvider.prototype._createMenuEntry = function (definition, element, action) {
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._getLoopEntries = function (element) {
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._getDataObjectIsCollection = function (element) {
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._getParticipantMultiplicity = function (element) {
 ...
 */
CustomViewerReplaceMenuProvider.prototype._getAdHocEntry = function (element) {
    var translate = this._translate;
    var businessObject = getBusinessObject(element);
