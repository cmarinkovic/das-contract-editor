 ...
 * @return {Array<Object>} a list of menu entry items
 */
CustomViewerReplaceMenuProvider.prototype.getHeaderEntries = function (
  element
) {
  var headerEntries = [];
 ...
 */
CustomViewerReplaceMenuProvider.prototype._createEntries = function (
  element,
  replaceOptions
) {
  var menuEntries = [];
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._createSequenceFlowEntries =
 ...
 */
CustomViewerReplaceMenuProvider.prototype._createMenuEntry = function (
  definition,
  element,
  action
) {
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._getDataObjectIsCollection =
  function (element) {
    var self = this;
    var translate = this._translate;
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomViewerReplaceMenuProvider.prototype._getParticipantMultiplicity =
  function (element) {
    var self = this;
    ...
    var participantMultiplicity =
      element.businessObject.participantMultiplicity;
